...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Employee Management System Services", Version = "v1" });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("https://localhost:7176/swagger/v1/swagger.json", "Employee Management System Services");
    });
}
